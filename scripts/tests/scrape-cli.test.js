// Test: scripts/scrape-x.js CLI arg validation
// Run: node scripts/tests/scrape-cli.test.js
...
try {
  execFileSync('node', ['scripts/scrape-x.js'], { cwd, encoding: 'utf-8', stdio: 'pipe' });
...
try {
  execFileSync('node', ['scripts/scrape-x.js', '--bogus', 'x'], { cwd, encoding: 'utf-8', stdio: 'pipe' });
...
try {
  execFileSync('node', ['scripts/scrape-x.js', '--login-only'], { cwd, encoding: 'utf-8', stdio: 'pipe', timeout: 10000 });
} catch (e) {
